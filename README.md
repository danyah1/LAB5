# LAB5
Accuracy Comparison
I experimented with the same dataset and code, but adjusted the value of top_k in Item_Name_reduced to 3, 5 and 11. The results showed only minor variations in model accuracy. Increasing top_k preserves more item categories instead of combining them under “Other”, which leads to slight changes in performance.
